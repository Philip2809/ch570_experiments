...
/******************************************************************************/
#ifndef __CH572BLE_LIB_PERI_H
#define __CH572BLE_LIB_PERI_H
...
#define ENV_SENS_SERV_UUID              0x181A  // Environmental Sensing
#define BODY_COMP_SERV_UUID             0x181B  // Body Composition
#define USER_DATA_SERV_UUID             0x181C  // User Data
#define WEIGHT_SCALE_SERV_UUID          0x181D  // Weight Scale
#define BOND_MANAGEMENT_SERV_UUID       0x181E  // Bond Management
#define GLUCOSE_MONITOR_UUID            0x181F  // Continuous Glucose Monitoring
...
#define TGAP_DISC_ADV_INT_MIN                   2   //!< Minimum advertising interval.Default 160. (n * 0.625 mSec)
#define TGAP_DISC_ADV_INT_MAX                   3   //!< Maximum advertising interval.Default 160. (n * 0.625 mSec)

// Proprietary
#define TGAP_SM_TIMEOUT                         4  //!< SM Message Timeout (milliseconds). Default 30 seconds.
#define TGAP_SM_MIN_KEY_LEN                     5  //!< SM Minimum Key Length supported. Default 7.
#define TGAP_SM_MAX_KEY_LEN                     6  //!< SM Maximum Key Length supported. Default 16.
#define TGAP_FILTER_ADV_REPORTS                 7  //!< Filter duplicate advertising reports. Default TRUE.
...
#define TGAP_PARAMID_MAX                        12  //!< ID MAX-valid Parameter ID
...
// GAP Advertising PHY VAL TYPE(GAP_PHY_VAL_TYPE)
...
/**
 * @brief   tmos system timer update
 *
 * @param   None
 *
 * @return  None
 */
extern bStatus_t TMOS_TimerSet( bleClockConfig_t *pClockConfig );
